class divide_8_test extends base_test;
	...
	virtual task run_scenario();
		$display("==========================================================================");
		$display("======================== TEST NAME: divide_8_test ========================");
		$display("==========================================================================");

		repeat (256) begin	
			//ITEM: Check the divide-by-8 behavior
			...
			if (pkt.randomize() with {addr == 8'h0; data[4:0] == {2'b11, 1'b0, 1'b0, 1'b1};}) begin
				write(pkt.addr, pkt.data);
				$display("%0t: [testcase] Write - addr = %b, data = %b", $time, pkt.addr, pkt.data);		
			end else begin
				$display("Randomization failed!");
