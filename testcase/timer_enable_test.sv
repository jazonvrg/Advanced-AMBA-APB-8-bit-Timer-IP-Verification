class timer_enable_test extends base_test;
	...
	virtual task run_scenario();
		$display("==========================================================================");
		$display("====================== TEST NAME: timer_enable_test ======================");
		$display("==========================================================================");

		repeat (20) begin		
			//ITEM: Check the timer_en behavior when timer_en = LOW
			...
			if (pkt.randomize() with {addr == 8'h0; data[4:0] == {2'b00, 1'b0, 1'b0, 1'b0};}) begin
				write(pkt.addr, pkt.data);
				$display("%0t: [testcase] Write - addr = %b, data = %b", $time, pkt.addr, pkt.data);
			end else begin
				$display("Randomization failed!");
			...
			//ITEM: Check the timer_en behavior when timer_en = HIGH
