class count_up_interrupt_test extends base_test;
	...
	virtual task run_scenario();
		$display("==========================================================================");
		$display("=================== TEST NAME: count_up_interrupt_test ===================");
		$display("==========================================================================");

		repeat (20) begin	
			//ITEM: Check the interrupt behavior when overflow_en = LOW
			
			reset();
			
			if (pkt.randomize() with {addr == 8'h3; data[0] == 1'b0;}) begin
			...
			while (1) begin
				...
				if (T2 - T1 >= (256 - env.scb.load_data) * 5ns + 7 * 5ns) begin
			...
			//ITEM: Check the interrupt behavior when overflow_en = HIGH
